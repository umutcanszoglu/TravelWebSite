<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LogoDark.ascx.cs" Inherits="TravelSite.UserControls.LogoDark" %>
<a href="Default.aspx">
    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="black" class="bi bi-boombox" viewBox="0 0 16 16">
